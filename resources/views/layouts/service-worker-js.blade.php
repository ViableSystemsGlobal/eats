<script>
    // TEMPORARILY DISABLED: Service Worker is interfering with Livewire requests
    ...
    // Unregister any existing service workers to prevent interference with Livewire
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.getRegistrations().then(function(registrations) {
            for(let registration of registrations) {
                registration.unregister();
                console.log('Service Worker unregistered to fix Livewire issues');
            }
        });
    }
