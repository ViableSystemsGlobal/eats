                    ...
                    <div
                        ...
                        @if ($taxFormat === 'reverse')
                            ...
                            <div class="flex justify-between text-sm font-semibold text-gray-700 dark:text-neutral-200">
                                ...
                                <div>{{ currency_format($taxCalculation['baseAmount']) }}</div>
                            </div>

                            {{-- Breakdown of components --}}
                            <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                                <div>@lang('modules.order.foodCost')</div>
                                <div>{{ currency_format($taxCalculation['foodCost']) }}</div>
                            </div>
                        ...
                        @else
                            ...
                            <div class="flex justify-between text-sm font-semibold text-gray-700 dark:text-neutral-200">
                                ...
                                <div>{{ currency_format($taxCalculation['subtotalAfterLevies']) }}</div>
                            </div>
