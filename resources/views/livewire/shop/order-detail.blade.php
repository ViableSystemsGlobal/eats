                ...
                <div class="space-y-2">
                    ...
                    @if ($taxFormat === 'reverse')
                        ...
                        <div class="flex items-center justify-between text-xs font-semibold">
                            <span class="text-gray-900 dark:text-white">@lang('modules.order.total') (Base Food Price)</span>
                            <span class="text-gray-900 dark:text-white">{{ currency_format($taxCalculation['baseAmount'], $restaurant->currency_id) }}</span>
                        </div>

                        {{-- Breakdown of components --}}
                        <div class="flex items-center justify-between text-xs">
                            <span class="text-gray-600 dark:text-gray-400">@lang('modules.order.foodCost')</span>
                            <span class="text-gray-900 dark:text-white">{{ currency_format($taxCalculation['foodCost'], $restaurant->currency_id) }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between text-xs font-semibold">
                            <span class="text-gray-900 dark:text-white">@lang('modules.order.total')</span>
                            <span class="text-gray-900 dark:text-white">{{ currency_format($taxCalculation['baseAmount'], $restaurant->currency_id) }}</span>
                        </div>
                    @else
                        ...
                        @foreach ($taxCalculation['levies'] as $levy)
                            <div class="flex items-center justify-between text-xs">
                                <span class="text-gray-600 dark:text-gray-400">{{ $levy['tax']->tax_name }} ({{ $levy['tax']->tax_percent }}%) <span class="text-gray-400 text-xs">(Levy)</span></span>
                                <span class="text-gray-900 dark:text-white">{{ currency_format($levy['amount'], $restaurant->currency_id) }}</span>
                            </div>
                        @endforeach
                        ...
                        <div class="flex items-center justify-between text-xs font-semibold">
                            <span class="text-gray-600 dark:text-gray-400">@lang('modules.order.subtotalAfterLevies')</span>
                            <span class="text-gray-900 dark:text-white">{{ currency_format($taxCalculation['subtotalAfterLevies'], $restaurant->currency_id) }}</span>
                        </div>

                        {{-- Display VAT on subtotal after levies --}}
                        @if ($taxCalculation['vat'])
                            <div class="flex items-center justify-between text-xs">
                                <span class="text-gray-600 dark:text-gray-400">{{ $taxCalculation['vat']['tax']->tax_name }} ({{ $taxCalculation['vat']['tax']->tax_percent }}%) <span class="text-gray-400 text-xs">(VAT)</span></span>
                                <span class="text-gray-900 dark:text-white">{{ currency_format($taxCalculation['vat']['amount'], $restaurant->currency_id) }}</span>
                            </div>
                        @endif
                    @endif
