     ...
     <div class="relative w-full max-w-4xl mx-4 bg-white rounded-lg shadow-xl dark:bg-gray-800" wire:click.stop>
         <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
             <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                 @lang('modules.reports.printJobDetails') #{{ $selectedPrintJob->id }}
             </h3>
         ...
         <div class="p-6">
             <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                 <div class="space-y-4">
                     <h4 class="text-lg font-medium text-gray-900 dark:text-white">@lang('modules.reports.basicInformation')</h4>
                     <div class="space-y-3">
                 ...
                 <div class="space-y-4">
                     <h4 class="text-lg font-medium text-gray-900 dark:text-white">@lang('modules.reports.printContent')</h4>
                     <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                         <div class="max-h-96 overflow-y-auto">
                             ...
                             @else
                                 <p class="text-sm text-gray-500 dark:text-gray-400">@lang('modules.reports.noContentAvailable')</p>
                             @endif
                         </div>
                     </div>
                 </div>
