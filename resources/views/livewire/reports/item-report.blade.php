    ...
    <div class="p-4 bg-white dark:bg-gray-800">
        <div class="mb-4">
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                @lang('modules.reports.itemReportMessage')
                @php
        ...
        <div class="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div class="flex items-center justify-between mb-2">
                <h3 class="text-sm font-medium text-skin-base dark:text-skin-base">@lang('modules.reports.sumOfTotalRevenue')</h3>
            ...
            <div class="flex items-center justify-between mb-2">
                <h3 class="text-sm font-medium text-emerald-600 dark:text-emerald-400">@lang('modules.reports.totalQuantitySold')</h3>
            ...
            <thead class="bg-gray-100 dark:bg-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-xs font-medium tracking-wider text-center text-gray-600 uppercase dark:text-gray-300">
                        @lang('modules.reports.quantitySold')
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider text-center text-gray-600 uppercase dark:text-gray-300">
                        @lang('modules.reports.sellingPrice')
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-end rtl:text-right text-gray-600 uppercase dark:text-gray-300">
                        @lang('modules.reports.totalRevenue')
                    </th>
                </tr>
            </thead>
