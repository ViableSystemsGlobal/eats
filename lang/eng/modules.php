...
return [
    ...
    'order' => [
        ...
        'totalItem' => 'Item(s)',
        'subTotal' => 'Sub Total',
        'subtotalAfterLevies' => 'Subtotal after levies',
        'foodCost' => 'Food Cost',
        'total' => 'Total',
        ...
        'addOrderName' => 'Add Order Name',
        'orderName' => 'Order Name',
        'orderNamePlaceholder' => 'e.g., Table 5 - Birthday Party, John\'s Order',
        'newItemsAdded' => 'New Items Added',
        'additionalPaymentRequired' => 'Additional Payment Required: :amount',
        ...
        'unservedOrdersToday' => 'Unserved Orders Today',
        'dine_in' => 'Dine In',
        'delivery' => 'Delivery',
        'pickup' => 'Pickup',
    ...
    'settings' => [
        ...
        'footerMessagePlaceholder' => 'Enter your custom footer message...',
        'footerMessageHelp' => 'This message will appear at the bottom of your receipts. Leave empty to use default message.',
        ...
        'taxFormat' => 'Tax Format',
        'taxFormatCurrent' => 'Current Format',
        'taxFormatCurrentDesc' => 'Tax is calculated on top of base food price (Base + Tax = Total)',
        'taxFormatReverse' => 'Reverse Format',
        'taxFormatReverseDesc' => 'Base food price becomes the total, broken down into components (Total = Food + COVID + VAT)',
