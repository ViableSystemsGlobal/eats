...
class SalesReportExport implements WithMapping, FromCollection, WithHeadings, WithStyles, ShouldAutoSize
{
    ...
    public function headings(): array
    {
        ...
        $headingTitle = $this->headingDateTime === $this->headingEndDateTime
                            ? __('modules.reports.salesDataFor') . " {$this->headingDateTime}, " . __('modules.reports.timePeriod') . " {$this->headingStartTime} - {$this->headingEndTime}"
                : __('modules.reports.salesDataFrom') . " {$this->headingDateTime} " . __('app.to') . " {$this->headingEndDateTime}, " . __('modules.reports.timePeriodEachDay') . " {$this->headingStartTime} - {$this->headingEndTime}";

        return [
            [__('menu.salesReport') . ' ' . $headingTitle],
            array_merge(
            [__('app.date'), __('modules.reports.totalOrders')],
            $this->charges,
            $taxHeadings,
            [
