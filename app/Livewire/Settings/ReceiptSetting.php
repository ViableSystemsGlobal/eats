...
class ReceiptSetting extends Component
{
    ...
    public function mount()
    {
        ...
        $this->footerMessage = $this->receiptSetting->footer_message ?? __('messages.thankYouVisit');
        $this->footerImage = $this->receiptSetting->footer_image_url;
        $this->showFooterImage = (bool)$this->receiptSetting->show_footer_image;
        $this->taxFormat = $this->receiptSetting->tax_format ?? 'current';
    }
    ...
    public function submitForm()
    {
        ...
        $data = [
            ...
            'show_footer_image' => $this->showFooterImage,
            'tax_format' => $this->taxFormat,
        ];
        ...
        // Handle Footer Image upload only if a new file is provided
        if ($this->footerImage instanceof TemporaryUploadedFile) {
            $data['footer_image'] = Files::uploadLocalOrS3(
                $this->footerImage,
                'footer_image',
                400,
                200
